...
using SectionContract = smart_meal_back.Contracts.Section;
using SectionModel = smart_meal_back.Models.SectionModel;
...
namespace smart_meal_back_test.Services
{
    ...
    public class ItemsServiceTests
    {
        ...
        public void GetItemsFromARestaurant_ShouldReturnList()
        {
            ...
            var criteria = new smart_meal_back.Utils.Criteria();
        ...
        public void CreateOrUpdateProduct_CompoundItem_ShouldCreateSectionsAndSubItems()
        {
            ...
            _itemsRepositoryMock
                .Setup(r => r.CreateOrUpdateSection(restaurantId, 100, It.IsAny<SectionContract>()))
                .Returns(200)
                .Verifiable();
